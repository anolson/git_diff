...
class LineTest < MiniTest::Unit::TestCase
  ...
  def test_from_string_with_addition
    addition = GitDiff::Line.from_string("+ addition", @line_number)
  ...
  def test_from_string_with_deletion
    deletion = GitDiff::Line.from_string("- deletion", @line_number)
  ...
  def test_from_string_with_context
    context = GitDiff::Line.from_string(" context", @line_number)
